  ...
  return (
    <div className="orders-page dashboard-page-container">
      <div className="orders-page-header">
        ...
        <button className={`m3-btn m3-btn-tonal refresh-btn ${loading ? "loading" : ""}`} onClick={fetchAllOrders} disabled={loading}>
              ...
              <div key={order._id || index} className="admin-order-card clickable-card m3-card m3-card-outlined" onClick={() => setSelectedOrder(order)}>
                ...
                <div className="order-actions-column" style={{ display: "flex", flexDirection: "column", gap: "12px", minWidth: "180px" }}>
                  {order.status === "Placed" ? (
                    ...
                    <div className="static-status-badge-container" onClick={(e) => e.stopPropagation()} style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                      <span className={`status-badge-static ${order.status.toLowerCase()}`} style={{
                        display: "inline-flex",
                        alignItems: "center",
                        gap: "6px",
                        padding: "8px 16px",
                        ...
                        justifyContent: "center",
                        border: "1px solid",
                        backgroundColor: order.status === "Delivered" ? "var(--md-sys-color-primary-container)" : (order.status === "Cancelled" ? "var(--md-sys-color-surface-container-high)" : "var(--md-sys-color-error-container)"),
                        color: order.status === "Delivered" ? "var(--md-sys-color-on-primary-container)" : (order.status === "Cancelled" ? "var(--md-sys-color-on-surface-variant)" : "var(--md-sys-color-on-error-container)"),
                        borderColor: order.status === "Delivered" ? "var(--md-sys-color-primary)" : (order.status === "Cancelled" ? "var(--md-sys-color-outline-variant)" : "var(--md-sys-color-error)")
                      }}>
                        <span className="material-symbols-outlined" style={{ fontSize: "1.1rem" }}>
                          {order.status === "Delivered" ? "check_circle" : (order.status === "Cancelled" ? "cancel" : "block")}
                        </span>
                        {order.status}
                      </span>
                    </div>
              ...
              <div className="preview-section" style={{ marginTop: "12px" }}>
                ...
                <div style={{ display: "flex", gap: "12px", width: "100%" }}>
                  ...
                  {selectedOrder.status === "Placed" ? (
                    ...
                    <div className="static-status-badge-container" style={{ flex: 2, display: "flex", justifyContent: "center" }}>
                      <span className={`status-badge-static ${selectedOrder.status.toLowerCase()}`} style={{
                        display: "inline-flex",
                        alignItems: "center",
                        gap: "6px",
                        padding: "10px 16px",
                        ...
                        justifyContent: "center",
                        border: "1px solid",
                        backgroundColor: selectedOrder.status === "Delivered" ? "var(--md-sys-color-primary-container)" : (selectedOrder.status === "Cancelled" ? "var(--md-sys-color-surface-container-high)" : "var(--md-sys-color-error-container)"),
                        color: selectedOrder.status === "Delivered" ? "var(--md-sys-color-on-primary-container)" : (selectedOrder.status === "Cancelled" ? "var(--md-sys-color-on-surface-variant)" : "var(--md-sys-color-on-error-container)"),
                        borderColor: selectedOrder.status === "Delivered" ? "var(--md-sys-color-primary)" : (selectedOrder.status === "Cancelled" ? "var(--md-sys-color-outline-variant)" : "var(--md-sys-color-error)")
                      }}>
                        <span className="material-symbols-outlined" style={{ fontSize: "1.1rem" }}>
                          {selectedOrder.status === "Delivered" ? "check_circle" : (selectedOrder.status === "Cancelled" ? "cancel" : "block")}
                        </span>
